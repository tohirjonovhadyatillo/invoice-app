...
function InvoiceCard({ invoice }) {
  ...
  return (
    <Link to={`/invoice/${invoiceId}`} className="block">
      <div className='hidden md:flex border cursor-pointer duration-100 ease-in-out hover:border hover:border-purple-500 py-4 shadow-sm px-6 dark:bg-[#1E2139] bg-white rounded-lg items-center justify-between'>
        <div className='flex items-center'>
          <h2 className='dark:text-white'>
            <span className='text-[#586089]'>#</span>
            {invoiceId}
          </h2>
